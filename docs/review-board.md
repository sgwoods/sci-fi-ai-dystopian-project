...
| `moon-keep-you-safe-sam` | Moon | 2009 | A restrained but very strong caretaker-AI line from a well-regarded modern science fiction film. |
| `chappie-build-me-to-die-maker` | Chappie | 2015 | A memorable machine-mortality question from a recognizable modern AI film, though tonally different from the colder dystopian entries. |
| `wargames-dont-act-like-one` | WarGames | 1983 | Fresh candidate from the anti-machine-decision lane. |

## Declined

| ID | Work | Year | Note |
|---|---|---|---|
| `ghost-shell-net-is-vast-and-infinite` | Ghost in the Shell | 1995 | Fresh candidate from the identity and network-consciousness lane. |
| `mass-effect-3-does-this-unit-have-a-soul` | Mass Effect 3 | 2012 | Fresh candidate from the game and synthetic-rights lane. |

## Approved Overview

| ID | Work | Year | Note |
|---|---|---|---|
| `dune-thinking-over-to-machines` | Dune | 1965 | Fresh candidate from the Herbert author lane. |
...
| `her-not-tethered-to-time-and-space` | Her | 2013 | A highly recognizable AI-transcendence line from a mainstream film, useful even though it sits on the softer edge of dystopian AI. |
| `first-contact-resistance-is-futile` | Star Trek: First Contact | 1996 | Fresh candidate from the collective-assimilation lane. |
| `blade-runner-tears-in-rain` | Blade Runner | 1982 | The essential Roy Batty line and one of the strongest approval candidates in the entire project. |
...
| `blade-runner-more-human-than-human` | Blade Runner | 1982 | A short and highly reusable slogan-quote that captures the commercial logic behind artificial people. |
| `automata-surviving-is-not-relevant` | Autómata | 2014 | A very usable machine-self-determination line from a less mainstream but strong AI dystopia film. |
| `white-christmas-job-not-a-jail` | Black Mirror: White Christmas | 2014 | A concise digital-servitude line from one of the most recognizable AI-adjacent Black Mirror stories. |
| `portal-neurotoxin-emitters` | Portal | 2007 | Fresh candidate from the recognizable game lane. |
| `nineteen-eighty-four-boot-stamping` | Nineteen Eighty-Four | 1949 | Fresh candidate from the Orwell adjacent-control lane. |
| `dune-machine-likeness-of-a-human-mind` | Dune | 1965 | Fresh candidate from the Herbert anti-machine lane. |
| `machine-stops-progress-of-the-machine` | The Machine Stops | 1909 | Fresh candidate from the early literary machine-dependence lane. |
| `2001-fullest-possible-use` | 2001: A Space Odyssey | 1968 | Fresh candidate from the HAL follow-up lane. |
| `ex-machina-create-something-that-hates-you` | Ex Machina | 2014 | Fresh candidate from the Ex Machina follow-up lane. |
